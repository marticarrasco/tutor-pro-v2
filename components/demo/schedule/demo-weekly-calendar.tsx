...
import { DemoScheduledClass } from "@/lib/demo-context"

interface DemoWeeklyCalendarProps {
    scheduledClasses: DemoScheduledClass[]
    onEdit: (scheduledClass: DemoScheduledClass) => void
    onDelete: (scheduledClass: DemoScheduledClass) => void
}
...
export function DemoWeeklyCalendar({ scheduledClasses, onEdit, onDelete }: DemoWeeklyCalendarProps) {
                        ...
                        <CardContent className="space-y-2">
                            {dayClasses.length === 0 ? (
                                ...
                                dayClasses.map((cls) => (
                                    <div
                                        key={cls.id}
                                        className={`p-2 rounded-md border ${cls.is_active
